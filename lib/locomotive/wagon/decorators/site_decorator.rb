module Locomotive
  module Wagon
    ...
    class SiteDecorator < SimpleDelegator
      ...
      %i(robots_txt timezone seo_title meta_keywords meta_description is_theme theme_name).each do |name|
      ...
      def __attributes__
        %i(name handle robots_txt locales timezone seo_title meta_keywords meta_description picture metafields_schema metafields metafields_ui is_theme theme_name)
      end
    ...
    class UpdateSiteDecorator < SiteDecorator
      ...
      def __attributes__
        %i(picture locales metafields_schema metafields metafields_ui is_theme theme_name)
      end
